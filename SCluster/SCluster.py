...
def SCluster(adata,c_nums=None,\
            ...
            results=False,alpha=0.75):
    
    print('Performing SCluster clustering... ',flush=True)
    ...
    print('The retained adata of the first clustering...',flush=True)
    print(cat_resluts,flush=True)
    print('---'*100,flush=True)
    print('adata for subclustering...',flush=True) 
    print(second_data,flush=True)
    print('---'*100,flush=True)
    ...
    try: 
        ...
        if c_nums==1:
            results_h5ad.obs[similarity_w]=int(cat_nums)
    ...
    end_time=time.time()
    print('SCluster done...',flush=True)
    print('SCluster takes {} secs'.format(end_time-start_time),flush=True)
    
    print(results_h5ad_first,flush=True)
